    ...
    <div className="rules-container">
      <div className="rules-question">
        ...
        <p>
          ...
          outcome as your Fitogachi dukes it out with your opponent's using you
          calories burned as pure POWER!
        </p>
        <p className="disclaimer">
          {" "}
          *Difference in level provides no empirical advantage*{" "}
        </p>
      </div>
      <div className="rules-answer">
        <AwesomeButton title={"CHALLENGE"} onClick={props.onClick} />
      </div>
    </div>
  );
}
